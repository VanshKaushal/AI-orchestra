  ...
  return (
    <div className="w-64 bg-[#0a0a0a] border-r border-zinc-800/50 flex flex-col h-full shrink-0">
      ...
      <div className="flex-1 overflow-y-auto px-2 space-y-0.5 scrollbar-hide py-2">
        <Link href="/" className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left transition-all ${pathname === "/" ? "bg-zinc-800 text-zinc-100" : "text-zinc-400 hover:bg-zinc-800/50 hover:text-zinc-200"} mb-0.5`}>
          <MessageSquare size={16} className={pathname === "/" ? "text-zinc-200" : "text-zinc-500"} />
          <div className="text-sm font-medium">Chat</div>
        </Link>
        <Link href="/graph" className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left transition-all ${pathname === "/graph" ? "bg-zinc-800 text-zinc-100" : "text-zinc-400 hover:bg-zinc-800/50 hover:text-zinc-200"} mb-2`}>
          <Share2 size={16} className={pathname === "/graph" ? "text-zinc-200" : "text-zinc-500"} />
